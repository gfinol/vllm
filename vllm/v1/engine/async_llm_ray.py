...
class AsyncLLMRay(EngineClient):
    ...
    def __init__(
        ...
        logger.info("AsyncLLM stat loggers: %s", self.stat_loggers)
        ...
        logger.info("Creating EngineCoreClient from AsyncLLMRay.")
    ...
    def process_inputs(
        ...
        request = processor.process_inputs(request_id, prompt, params,
    ...
    async def add_request(
        ...
        request = await self.processor.process_inputs_async(request_id, prompt,
                                                   params, arrival_time,
                                                   lora_request, trace_headers,
                                                   prompt_adapter_request,
                                                   priority)
        # request = await AsyncLLMRay.process_inputs.remote(self.processor, request_id, prompt,
        #                                            params, arrival_time,
        #                                            lora_request, trace_headers,
        #                                            prompt_adapter_request,
        #                                            priority)
        ...
        # logger.info(f"Request2: {request2}")

        # assert request == request2, "Request and request2 should be the same"
    ...
    async def generate(
        ...
        """
        logger.info("AsyncLLMRay.generate() called (V1).")
        try:
