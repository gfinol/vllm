...
import vllm
from vllm import LLM, EngineArgs, SamplingParams, AsyncEngineArgs
...
# from vllm.v1.engine.async_llm_ray import AsyncLLMRay as AsyncLLM
...
async def gen(async_engine: AsyncLLM, input, sampling_params, lora_request):
...
async def main_async(args):
    ...
    with time_counter(args.time_generate):
        for input in inputs:
            outputs.append(asyncio.create_task(gen(async_engine, input, sampling_params, lora_request)))
